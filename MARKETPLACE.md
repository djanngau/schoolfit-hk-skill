...
SchoolFit HK helps OpenClaw, CowAgent, Claude Code, and compatible agents support Hong Kong secondary-school selection workflows. It can search schools, inspect school details, compare shortlists, produce Safe / Match / Reach recommendation buckets, query EDB vacancy records, and retrieve school admission notices.
